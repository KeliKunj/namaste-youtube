...
// Example usage
console.log(new Date(),  new Date(publishedAt), getReadableDateDifference(new Date(), new Date(publishedAt)));

  return (
    <div className={`border broder-gray shadow-md rounded-lg w-56 m-2 p-4 hover:shadow-xl hover:p-2`}>
      ...
      <h4 className='text-xs text-gray-600'>{getReadableDateDifference(new Date(), new Date(publishedAt)) || "just now"}</h4>
      </div>
